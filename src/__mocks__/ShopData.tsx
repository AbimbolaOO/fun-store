...
interface ItemSectionable {
  sectionTitle: string;
  sectionData: ItemComp[];
}

const ShopData: ItemSectionable[] = [
  {
    sectionTitle: 'Bed',
    sectionData: [
      {
  ...
  {
    sectionTitle: 'Decor and accessories',
    sectionData: [
      {
        imgSrc: '/static/img/dinma-3-seater-1.jpg',
        imgSrc2: '/static/img/dinma-3-seater.jpg',
