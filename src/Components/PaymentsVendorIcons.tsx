...
export const Paypal: React.FC<SvgDimensions> = ({
  width = '38px',
  height = '24px',
}) => {
  return (
...
export const Opay: React.FC<SvgDimensions> = ({
  width = '38px',
  height = '24px',
}) => {
  return (
...
export const Visa: React.FC<SvgDimensions> = ({
  width = '38px',
  height = '24px',
}) => {
  return (
...
export const Master: React.FC<SvgDimensions> = ({
  width = '38px',
  height = '24px',
}) => {
  return (
...
export const Maestro: React.FC<SvgDimensions> = ({
  width = '38px',
  height = '24px',
}) => {
  return (
...
export const Discovery: React.FC<SvgDimensions> = ({
  width = '38px',
  height = '24px',
}) => {
  return (
